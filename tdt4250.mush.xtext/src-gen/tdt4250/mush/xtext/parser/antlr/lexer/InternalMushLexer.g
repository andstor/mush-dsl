 ...
 */
lexer grammar InternalMushLexer;
...
BiggerThen : ('B'|'b')('I'|'i')('G'|'g')('G'|'g')('E'|'e')('R'|'r')('T'|'t')('H'|'h')('E'|'e')('N'|'n');
...
LessThen : ('L'|'l')('E'|'e')('S'|'s')('S'|'s')('T'|'t')('H'|'h')('E'|'e')('N'|'n');
...
Modulo : ('M'|'m')('O'|'o')('D'|'d')('U'|'u')('L'|'l')('O'|'o');
