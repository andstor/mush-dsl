...
import tdt4250.mush.xtext.generator.MushGeneratorUtils;
import tdt4250.mush.xtext.generator.MushTypeInferencer;
...
public class MushGenerator extends AbstractGenerator {
  private MushTypeInferencer typeInferencer = new MushTypeInferencer();
  ...
  public String generate(final Function e) {
    ...
    if ((this.packageName != null)) {
      ...
      string = (_string + (("package " + this.packageName) + ";\n\n"));
    }
    for (final String importType : this.importTypes) {
      String _string_1 = string;
      string = (_string_1 + (("import " + importType) + ";\n"));
    }
    boolean _isEmpty_1 = this.importTypes.isEmpty();
  ...
  protected Object _LiteralExpression(final StringLiteral e) {
    String _escape = MushGeneratorUtils.escape(e.getValue());
