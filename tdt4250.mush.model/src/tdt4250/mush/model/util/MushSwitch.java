 ...
 * @generated
 */
public class MushSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MushPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.FUNCTION: {
				Function function = (Function)theEObject;
				T result = caseFunction(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = caseFeature(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.EXPRESSION: {
			...
			case MushPackage.IF_STATEMENT: {
				IfStatement ifStatement = (IfStatement)theEObject;
				T result = caseIfStatement(ifStatement);
				if (result == null) result = caseStatement(ifStatement);
				if (result == null) result = caseFeature(ifStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.FOR_STATEMENT: {
				ForStatement forStatement = (ForStatement)theEObject;
				T result = caseForStatement(forStatement);
				if (result == null) result = caseStatement(forStatement);
				if (result == null) result = caseFeature(forStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.WHILE_STATEMENT: {
				WhileStatement whileStatement = (WhileStatement)theEObject;
				T result = caseWhileStatement(whileStatement);
				if (result == null) result = caseStatement(whileStatement);
				if (result == null) result = caseFeature(whileStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.STOP: {
				Stop stop = (Stop)theEObject;
				T result = caseStop(stop);
				if (result == null) result = caseStatement(stop);
				if (result == null) result = caseFeature(stop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.PRINT: {
				Print print = (Print)theEObject;
				T result = casePrint(print);
				if (result == null) result = caseExpression(print);
				if (result == null) result = caseFeature(print);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.FUNCTION_CALL: {
				FunctionCall functionCall = (FunctionCall)theEObject;
				T result = caseFunctionCall(functionCall);
				if (result == null) result = caseExpression(functionCall);
				if (result == null) result = caseFeature(functionCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.COLLECTION: {
				Collection collection = (Collection)theEObject;
				T result = caseCollection(collection);
				if (result == null) result = caseExpression(collection);
				if (result == null) result = caseFeature(collection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.VARIABLE: {
			...
			case MushPackage.COLLECTION_ADD: {
				CollectionAdd collectionAdd = (CollectionAdd)theEObject;
				T result = caseCollectionAdd(collectionAdd);
				if (result == null) result = caseExpression(collectionAdd);
				if (result == null) result = caseFeature(collectionAdd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.COLLECTION_REMOVE: {
				CollectionRemove collectionRemove = (CollectionRemove)theEObject;
				T result = caseCollectionRemove(collectionRemove);
				if (result == null) result = caseExpression(collectionRemove);
				if (result == null) result = caseFeature(collectionRemove);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.VALUE_EXCHANGE: {
				ValueExchange valueExchange = (ValueExchange)theEObject;
				T result = caseValueExchange(valueExchange);
				if (result == null) result = caseExpression(valueExchange);
				if (result == null) result = caseFeature(valueExchange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.LIST: {
			...
			case MushPackage.SET_LITTERAL: {
				SetLitteral setLitteral = (SetLitteral)theEObject;
				T result = caseSetLitteral(setLitteral);
				if (result == null) result = caseCollection(setLitteral);
				if (result == null) result = caseExpression(setLitteral);
				if (result == null) result = caseFeature(setLitteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.LIST_LITTERAL: {
				ListLitteral listLitteral = (ListLitteral)theEObject;
				T result = caseListLitteral(listLitteral);
				if (result == null) result = caseCollection(listLitteral);
				if (result == null) result = caseExpression(listLitteral);
				if (result == null) result = caseFeature(listLitteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.COLLECTION_ACCESSOR: {
				CollectionAccessor collectionAccessor = (CollectionAccessor)theEObject;
				T result = caseCollectionAccessor(collectionAccessor);
				if (result == null) result = caseExpression(collectionAccessor);
				if (result == null) result = caseFeature(collectionAccessor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.AND_OR_EXPRESSION: {
				...
				if (result == null) result = caseFeature(andOrExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.COMPARISON: {
				Comparison comparison = (Comparison)theEObject;
				T result = caseComparison(comparison);
				if (result == null) result = caseExpression(comparison);
				if (result == null) result = caseFeature(comparison);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.EQUALS: {
				Equals equals = (Equals)theEObject;
				T result = caseEquals(equals);
				if (result == null) result = caseExpression(equals);
				if (result == null) result = caseFeature(equals);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.PLUS: {
				Plus plus = (Plus)theEObject;
				T result = casePlus(plus);
				if (result == null) result = caseExpression(plus);
				if (result == null) result = caseFeature(plus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.MINUS: {
				Minus minus = (Minus)theEObject;
				T result = caseMinus(minus);
				if (result == null) result = caseExpression(minus);
				if (result == null) result = caseFeature(minus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.MULTI_OR_DIV: {
				...
				if (result == null) result = caseFeature(multiOrDiv);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.BOOLEAN_NEGATION: {
				...
				if (result == null) result = caseFeature(booleanNegation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.ARITHMETIC_SIGNED: {
				...
				if (result == null) result = caseFeature(arithmeticSigned);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.PARENTHESIZED_EXPRESSION: {
				...
				if (result == null) result = caseFeature(parenthesizedExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.NUMBER_LITERAL: {
				NumberLiteral numberLiteral = (NumberLiteral)theEObject;
				T result = caseNumberLiteral(numberLiteral);
				if (result == null) result = caseExpression(numberLiteral);
				if (result == null) result = caseFeature(numberLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.STRING_LITERAL: {
				StringLiteral stringLiteral = (StringLiteral)theEObject;
				T result = caseStringLiteral(stringLiteral);
				if (result == null) result = caseExpression(stringLiteral);
				if (result == null) result = caseFeature(stringLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.BOOLEAN_LITERAL: {
				BooleanLiteral booleanLiteral = (BooleanLiteral)theEObject;
				T result = caseBooleanLiteral(booleanLiteral);
				if (result == null) result = caseExpression(booleanLiteral);
				if (result == null) result = caseFeature(booleanLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.VARIABLE_REFERENCE: {
				VariableReference variableReference = (VariableReference)theEObject;
				T result = caseVariableReference(variableReference);
				if (result == null) result = caseExpression(variableReference);
				if (result == null) result = caseFeature(variableReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.TYPE: {
				Type type = (Type)theEObject;
				T result = caseType(type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.DOUBLE_LITERAL: {
				DoubleLiteral doubleLiteral = (DoubleLiteral)theEObject;
				T result = caseDoubleLiteral(doubleLiteral);
				if (result == null) result = caseExpression(doubleLiteral);
				if (result == null) result = caseFeature(doubleLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.SIZE_EXPRESSION: {
				SizeExpression sizeExpression = (SizeExpression)theEObject;
				T result = caseSizeExpression(sizeExpression);
				if (result == null) result = caseExpression(sizeExpression);
				if (result == null) result = caseFeature(sizeExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MushPackage.COLLECTION_SET: {
				CollectionSet collectionSet = (CollectionSet)theEObject;
				T result = caseCollectionSet(collectionSet);
				if (result == null) result = caseExpression(collectionSet);
				if (result == null) result = caseFeature(collectionSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
