 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.mush.model.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleLiteralImpl extends ExpressionImpl implements DoubleLiteral {
	...
	protected EClass eStaticClass() {
		return MushPackage.Literals.DOUBLE_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MushPackage.DOUBLE_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MushPackage.DOUBLE_LITERAL__VALUE:
				return getValue();
		}
