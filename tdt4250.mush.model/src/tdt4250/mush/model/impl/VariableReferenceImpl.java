 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.mush.model.impl.VariableReferenceImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableReferenceImpl extends ExpressionImpl implements VariableReference {
	...
	protected EClass eStaticClass() {
		return MushPackage.Literals.VARIABLE_REFERENCE;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MushPackage.VARIABLE_REFERENCE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Variable newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MushPackage.VARIABLE_REFERENCE__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MushPackage.VARIABLE_REFERENCE__REF:
