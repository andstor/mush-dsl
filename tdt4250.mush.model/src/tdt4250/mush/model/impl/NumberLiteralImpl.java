 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.mush.model.impl.NumberLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberLiteralImpl extends ExpressionImpl implements NumberLiteral {
	...
	protected EClass eStaticClass() {
		return MushPackage.Literals.NUMBER_LITERAL;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MushPackage.NUMBER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MushPackage.NUMBER_LITERAL__VALUE:
				return getValue();
		}
