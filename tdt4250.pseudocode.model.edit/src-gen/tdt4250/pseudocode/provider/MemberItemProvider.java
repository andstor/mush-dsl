...
/**
 * This is the item provider adapter for a {@link tdt4250.pseudocode.Member} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemberItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Member_visibility_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Member_visibility_feature",
								"_UI_Member_type"),
						PseudocodePackage.Literals.MEMBER__VISIBILITY, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Member_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Member_type_feature", "_UI_Member_type"),
						PseudocodePackage.Literals.MEMBER__TYPE, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Member_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Member_name_feature", "_UI_Member_type"),
						PseudocodePackage.Literals.MEMBER__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
