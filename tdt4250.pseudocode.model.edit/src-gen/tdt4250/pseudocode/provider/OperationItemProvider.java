...
/**
 * This is the item provider adapter for a {@link tdt4250.pseudocode.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider extends MemberItemProvider {
	...
	protected void addExceptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Operation_exceptions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_exceptions_feature",
								"_UI_Operation_type"),
						PseudocodePackage.Literals.OPERATION__EXCEPTIONS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PseudocodePackage.Literals.OPERATION__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PseudocodePackage.Literals.OPERATION__PARAMETERS,
				PseudocodeFactory.eINSTANCE.createParameter()));
	}
