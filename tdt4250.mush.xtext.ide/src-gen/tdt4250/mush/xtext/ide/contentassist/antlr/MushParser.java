...
public class MushParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MushGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MushGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCollectionSetAccess().getGroup(), "rule__CollectionSet__Group__0");
			builder.put(grammarAccess.getCollectionSetAccess().getGroup_3(), "rule__CollectionSet__Group_3__0");
			builder.put(grammarAccess.getCollectionSetAccess().getGroup_3_1(), "rule__CollectionSet__Group_3_1__0");
			...
			builder.put(grammarAccess.getSetLitteralAccess().getGroup_3(), "rule__SetLitteral__Group_3__0");
			builder.put(grammarAccess.getListLitteralAccess().getGroup(), "rule__ListLitteral__Group__0");
			builder.put(grammarAccess.getListLitteralAccess().getGroup_3(), "rule__ListLitteral__Group_3__0");
			...
			builder.put(grammarAccess.getSizeExpressionAccess().getGroup(), "rule__SizeExpression__Group__0");
			...
			builder.put(grammarAccess.getCollectionSetAccess().getCollectionAssignment_1(), "rule__CollectionSet__CollectionAssignment_1");
			builder.put(grammarAccess.getCollectionSetAccess().getLeftAssignment_3_0(), "rule__CollectionSet__LeftAssignment_3_0");
			builder.put(grammarAccess.getCollectionSetAccess().getLeftAssignment_3_1_1(), "rule__CollectionSet__LeftAssignment_3_1_1");
			builder.put(grammarAccess.getCollectionSetAccess().getRightAssignment_5(), "rule__CollectionSet__RightAssignment_5");
			...
			builder.put(grammarAccess.getSetLitteralAccess().getElementsAssignment_2(), "rule__SetLitteral__ElementsAssignment_2");
			builder.put(grammarAccess.getSetLitteralAccess().getElementsAssignment_3_1(), "rule__SetLitteral__ElementsAssignment_3_1");
			builder.put(grammarAccess.getListLitteralAccess().getElementsAssignment_2(), "rule__ListLitteral__ElementsAssignment_2");
			builder.put(grammarAccess.getListLitteralAccess().getElementsAssignment_3_1(), "rule__ListLitteral__ElementsAssignment_3_1");
			...
			builder.put(grammarAccess.getSizeExpressionAccess().getValueAssignment_3(), "rule__SizeExpression__ValueAssignment_3");
	...
	@Override
	protected InternalMushParser createParser() {
		InternalMushParser result = new InternalMushParser(null);
