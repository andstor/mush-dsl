...
public class PcodeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PcodeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getIfAccess().getAlternatives_3_1(), "rule__If__Alternatives_3_1");
			...
			builder.put(grammarAccess.getIfAccess().getGroup_3_1_0(), "rule__If__Group_3_1_0__0");
			builder.put(grammarAccess.getIfAccess().getGroup_3_1_2(), "rule__If__Group_3_1_2__0");
