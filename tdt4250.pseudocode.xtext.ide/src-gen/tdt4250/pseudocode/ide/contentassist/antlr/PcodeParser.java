...
public class PcodeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PcodeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getListAccess().getTypeAlternatives_3_0(), "rule__List__TypeAlternatives_3_0");
			builder.put(grammarAccess.getListAccess().getAlternatives_4(), "rule__List__Alternatives_4");
			...
			builder.put(grammarAccess.getListAccess().getTypeAssignment_3(), "rule__List__TypeAssignment_3");
