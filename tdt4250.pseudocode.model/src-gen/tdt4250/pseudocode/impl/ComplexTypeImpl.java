...
import tdt4250.pseudocode.ComplexType;
 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.ComplexTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexTypeImpl extends MinimalEObjectImpl.Container implements ComplexType {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.COMPLEX_TYPE;
	}
	...
	public EList<TypeLiteral> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<TypeLiteral>(TypeLiteral.class, this,
					PseudocodePackage.COMPLEX_TYPE__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PseudocodePackage.COMPLEX_TYPE__TYPES:
