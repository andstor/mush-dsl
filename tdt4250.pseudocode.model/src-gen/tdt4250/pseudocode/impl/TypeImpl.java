 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.TypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeImpl extends MinimalEObjectImpl.Container implements Type {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.TYPE;
	}
	...
	public EList<String> getTypes() {
		if (types == null) {
			types = new EDataTypeEList<String>(String.class, this, PseudocodePackage.TYPE__TYPES);
		}
		return types;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.TYPE__TYPES:
			return getTypes();
		}
