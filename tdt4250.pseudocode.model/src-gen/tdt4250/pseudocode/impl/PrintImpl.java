...
public class PrintImpl extends ExpressionImpl implements Print {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.PRINT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.PRINT__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetValue(Expression newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PseudocodePackage.PRINT__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PseudocodePackage.PRINT__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.PRINT__VALUE, newValue, newValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.PRINT__NAME:
			return getName();
		case PseudocodePackage.PRINT__VALUE:
			return getValue();
