 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleLiteralImpl extends ExpressionImpl implements DoubleLiteral {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.DOUBLE_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.DOUBLE_LITERAL__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.DOUBLE_LITERAL__VALUE:
			return getValue();
		}
