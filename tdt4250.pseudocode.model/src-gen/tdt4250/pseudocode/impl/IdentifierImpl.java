 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.IdentifierImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifierImpl extends MinimalEObjectImpl.Container implements Identifier {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.IDENTIFIER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.IDENTIFIER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.IDENTIFIER__NAME:
			return getName();
		}
