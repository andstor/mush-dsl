 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.BodyImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BodyImpl extends MinimalEObjectImpl.Container implements Body {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.BODY;
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this,
					PseudocodePackage.BODY__STATEMENTS);
		}
		return statements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PseudocodePackage.BODY__STATEMENTS:
