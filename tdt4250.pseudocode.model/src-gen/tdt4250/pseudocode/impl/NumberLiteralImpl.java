 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.NumberLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberLiteralImpl extends LiteralImpl implements NumberLiteral {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.NUMBER_LITERAL;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.NUMBER_LITERAL__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.NUMBER_LITERAL__VALUE:
			return getValue();
		}
