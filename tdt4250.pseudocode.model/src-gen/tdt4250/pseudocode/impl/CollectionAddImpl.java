 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.CollectionAddImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link tdt4250.pseudocode.impl.CollectionAddImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionAddImpl extends ExpressionImpl implements CollectionAdd {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.COLLECTION_ADD;
	}
			...
			if (collection != oldCollection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PseudocodePackage.COLLECTION_ADD__COLLECTION, oldCollection, collection));
			}
		}
		return collection;
	}
	...
	public void setCollection(Variable newCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.COLLECTION_ADD__COLLECTION,
	...
	public NotificationChain basicSetValue(Expression newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PseudocodePackage.COLLECTION_ADD__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PseudocodePackage.COLLECTION_ADD__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.COLLECTION_ADD__VALUE, newValue,
					newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PseudocodePackage.COLLECTION_ADD__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.COLLECTION_ADD__COLLECTION:
			if (resolve)
