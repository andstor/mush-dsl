 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.pseudocode.impl.BooleanLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralImpl extends ExpressionImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return PseudocodePackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PseudocodePackage.BOOLEAN_LITERAL__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PseudocodePackage.BOOLEAN_LITERAL__VALUE:
			return getValue();
		}
